%% ARCHIVAL FILE: Code_Figure_04.m
...
% 2) This script loads Master_Numerical_Data.mat, so Fig. 4 uses the
...
exportgraphics(fig, ...
    fullfile(thisDir,'Figure_04.pdf'), ...
    'ContentType','vector');

exportgraphics(fig, ...
    fullfile(thisDir,'Figure_04.png'), ...
    'Resolution',600);
